# -*- coding: utf-8 -*-
#
# pytest-gdeploy-config documentation build configuration file, created by
...
project = u'pytest-gdeploy-config'
copyright = u'2015, Filip Balák'
author = u'Filip Balák'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-gdeploy-config Documentation',
     [author], 1)
]
